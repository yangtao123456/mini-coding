...
public class FunnyGameUtil {
     ...
     */
    public static String simpleOut(int number){
     ...
     * 2. For multiples of five or has a 5 in it(Example: 5, 51), return BUZZ;
     * 3. If it satisfy 1 & 2 criterias together(Example: 45, 53).
     * 4. Else return input number.
     *
     * @param   number   the number that user say
     * @return  the funny word.
     */
    public static String complexOut(int number){
        int modByThree = Math.floorMod(number, 3), modByFive = Math.floorMod(number, 5);
